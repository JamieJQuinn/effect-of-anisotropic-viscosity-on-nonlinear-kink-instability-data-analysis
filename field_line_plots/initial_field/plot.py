...
def save_fig(data_fname, fig_fname):
    ...
    IntegralCurveAtts.sampleDensity0 = 6
...
def main():
    ...
    filenames = ["/nas/1101974q/archie-latest-organisation-sept-2018/kink-instabilities/initially-unstable/cadence-5-v1e-4r5e-4.5/v1e-4r5e-4.5-isotropic/Data/0000.sdf"]
